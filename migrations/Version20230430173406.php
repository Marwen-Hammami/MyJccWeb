 ...
 */
final class Version20230430173406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(255) NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP Nom, DROP Prenom, DROP Genre, DROP MotDePasse, DROP Role, DROP NumTel, CHANGE Email email VARCHAR(255) NOT NULL, CHANGE PhotoB64 photob64 VARCHAR(255) NOT NULL, CHANGE ID_User id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON user');
        $this->addSql('ALTER TABLE user ADD Nom VARCHAR(30) NOT NULL, ADD Prenom VARCHAR(30) NOT NULL, ADD Genre VARCHAR(30) NOT NULL, ADD MotDePasse VARCHAR(100) NOT NULL, ADD Role VARCHAR(30) NOT NULL, ADD NumTel INT DEFAULT NULL, DROP username, DROP password, CHANGE email Email VARCHAR(50) NOT NULL, CHANGE photob64 PhotoB64 TEXT NOT NULL, CHANGE id ID_User INT AUTO_INCREMENT NOT NULL');
