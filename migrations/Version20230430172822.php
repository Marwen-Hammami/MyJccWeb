 ...
 */
final class Version20230430172822 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE logs (ID_Logs INT AUTO_INCREMENT NOT NULL, ID_User INT DEFAULT NULL, Date DATE NOT NULL, Action VARCHAR(254) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, INDEX ID_User (ID_User), PRIMARY KEY(ID_Logs)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
