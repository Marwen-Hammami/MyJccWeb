...
class PrixController extends AbstractController
{
    ...
    #[Route('/{idPrix}', name: 'app_prix_show', methods: ['GET'])]
    ...
    #[Route('/{idPrix}/edit', name: 'app_prix_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idPrix}', name: 'app_prix_delete', methods: ['POST'])]
    public function delete(Request $request, Prix $prix, PrixRepository $prixRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$prix->getIdPrix(), $request->request->get('_token'))) {
