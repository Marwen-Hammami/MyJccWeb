 ...
 */
class getCustomLoginAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\CustomLoginAuthenticator' shared autowired service.
     *
     * @return \App\Security\CustomLoginAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'CustomLoginAuthenticator.php';

        return $container->privates['App\\Security\\CustomLoginAuthenticator'] = new \App\Security\CustomLoginAuthenticator(($container->services['router'] ?? $container->getRouterService()), ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')));
    }
}
